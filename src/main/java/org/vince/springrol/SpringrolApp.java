package org.vince.springrol;

import org.vince.springrol.config.Constants;
import org.vince.springrol.config.JHipsterProperties;
...
public class SpringrolApp {

    private static final Logger log = LoggerFactory.getLogger(SpringrolApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes springrol.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SpringrolApp.class);
